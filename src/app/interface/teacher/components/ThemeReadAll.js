                    ...
                    <table className="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Smart Cities</td>
                                <td>
                                    Gastar menos e oferecer melhores servicos: esse eh o objetivo das cidades do futuro. Como conseguir isso? Implementando
                                    hardware e softwares de baixo nivel, propondo novas arquiteturas de servico, manipulando grandes bases de dados e integrando
                                    solucoes tecnologicas a outras areas de conhecimento.
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    enormes bases de dados (big data) ou prever comportamento de usuarios e sistemas (predective analytic). Atualmente as bases
                                    de dados publicas possuem informacoes demais e poucas ferramentas para isso.
                                </td>
                            </tr>
                        </tbody>
                    </table>
