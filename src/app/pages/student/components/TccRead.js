...
export default function TccRead() {
  return (
    <main>
        ...
        <div className="px-4 py-5">
          ...
          <div class="card">
            <div class="card-body text-bg-secondary">
              ...
              <p class="card-text">
                <strong>Descrição do tema: </strong>Gastar menos e oferecer melhores servicos: esse eh o objetivo das cidades do futuro. Como conseguir isso? Implementando hardware
                e softwares de baixo nivel, propondo novas arquiteturas de servico, manipulando grandes bases de dados e integrando solucoes tecnologicas a outras areas de
                conhecimento.
              </p>
            </div>
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item">
                <strong>Situação do profesor: </strong>Orientação Aceita
              </li>
              <li class="list-group-item">
