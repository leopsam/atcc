    ...
    <main>
      <section className={style.dashboard}>
        <div className="text-black bg-body-secondary py-4 px-5 text-center">
          ...
          <p className="fs-6">
            Este é um sistema que revoluciona o modo de orientar o trabalho de conclusão de curso, onde o aluno e orientador possam se comunicar é um sistema que revoluciona o modo
            de orientar o trabalho de conclusão de curso, onde o aluno e orientador possam se comunicar é um sistema que revoluciona o modo de orientar o trabalho de conclusão de
            curso, onde o aluno e orientador possam se comunicar é um sistema que revoluciona o modo de orientar o trabalho de conclusão de curso, onde o aluno e orientador possam
            se comunicar.
          </p>
        </div>
        <div className="p-2 d-flex align-items-center justify-content-center border-bottom">
          ...
          <div className="col-md-6 m-3">
            <div className="input-group">
              <input type="text" className="form-control border-dark-subtle  text-black" placeholder="Buscar" aria-label="Recipient's username" aria-describedby="button-addon2" />
