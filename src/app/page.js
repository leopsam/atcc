            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <div className="d-flex flex-column align-items-lg-start m-2">
                <form className="d-flex" role="Login">
                  <input className="form-control form-control-sm me-2" type="text" placeholder="Login" aria-label="Login" />
                  <input className="form-control form-control-sm me-2" type="password" placeholder="Senha" aria-label="Senha" />
        ...
        <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              ...
              <Image src={objDesktop} className="d-block w-100 img-fluid d-none d-md-block" alt="Imagem do carrossel contexto objetivo, para desktop" />
              <div className="overlay" />
              <div className="carousel-caption d-none d-md-block custom-carousel-caption">
                <h1>OBJETIVO</h1>
                <p>Ajudar na orientação do aluno disponibilizando sujestões de temas, Orientatores e todo o processo dividido em etapas, neste caminho dificio que é o T.C.C.</p>
              </div>
            </div>
            <div className="carousel-item">
              <Image src={versMobile} className="d-block w-100 img-fluid d-md-none" alt="Imagem do carrossel contexto versatilidade, para mobile" />
              <Image src={versDesktop} className="d-block w-100 img-fluid d-none d-md-block" alt="Imagem do carrossel contexto versatilidade, para desktop" />
              <div className="overlay" />
              <div className="carousel-caption d-none d-md-block custom-carousel-caption">
                <h1>VERSATILIDADE</h1>
            ...
            <div className="carousel-item">
              ...
              <Image src={contDesktop} className="d-block w-100 img-fluid d-none d-md-block" alt="Imagem do carrossel contexto conteudo, para desktop" />
              <div className="overlay" />
              <div className="carousel-caption d-none d-md-block custom-carousel-caption">
                <h1>CONTEUDO</h1>
                <p>O Sistema não só tem a comunicação entre aluno e orientador como tambem tem conteudos como ajuda com perguntas e respostas e uma biblioteca de arquivos.</p>
              </div>
            </div>
          </div>
        ...
        <div className="modal-dialog text-black">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <p className="">Para recuperar a senha informe seu CPF e email, em seguida aparecera uma notificação com uma senha padrão, mude a senha se achar necessário.</p>
              <form>
